...
describe('set function', () => {
    ...
    test('will have space between pair strings', () => {
        assert.equal(set({ key1: 'value1', key2: 'value2'}), ' key1="value1" key2="value2"')
    })

    test('will force values to be strings', () => {
        assert.equal(set({ function: () => () => {}, boolean: true, object: { key: "value"}, array: ['first', 'second']}), ` function="() => {\n    }" boolean="true" object="{ key: 'value' }" array="[ 'first', 'second' ]"`)
    })
})
...
describe('element function', () => {
    ...
    test('can add attributes to an element string', () => {
        assert.equal(element('element', false, { key1: 'value1', key2: 'value2'}), '<element key1="value1" key2="value2"></element>')
    })

    test('can add attributes to a selfClosing element string', () => {
        assert.equal(element('element', true, { key1: 'value1', key2: 'value2'}), '<element key1="value1" key2="value2">')
    })

    test('can add children to an element string', () => {
        assert.equal(element('element', false, { key1: 'value1', key2: 'value2'}, 'text', '<child>'), '<element key1="value1" key2="value2">text<child></element>')
    })

    test("won't add children to a selfClosing element string", () => {
        assert.equal(element('element', true, { key1: 'value1', key2: 'value2'}, 'text', '<child>'), '<element key1="value1" key2="value2">')
    })
})